...
- 增加手势校准页，让不同摄像头角度和光照环境下的识别更稳定。
- 增加截图/GIF 到 README，提升简历展示直观度。
- 将手势识别、游戏状态和渲染进一步拆分，补充单元测试。
- 打包为 Windows 可执行文件，降低演示环境配置成本。

## 许可与素材说明

代码以 MIT License 开源。当前图片和音频素材随项目用于学习和作品集展示，来源许可需在商业用途前重新确认；详见 [NOTICE.md](NOTICE.md)。
